...
public class OrderMidaVo {
    ...
    public OrderMidaVo(Integer oId, Integer oStatus, Integer oCancelType, String oEvaluation, String oEvaluationAdd, String oCancelReason, Date oCreateTime, Date oPayTime, Date oRemindShipments, Date oShipmentsTime, Date oRemindReceive, Date oReceiveTime, Date oEvaluationTime, Date oEvaluationAddTime, Integer oSellDelete, Integer oBuyDelete, String oTradeNo, List<OrderEvaluationMedia> orderEvaluationMedia) {
        this.oId = oId;
